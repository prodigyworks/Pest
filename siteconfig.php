...
<?php
	if (isset($_POST['domainurl'])) {
		...
		$qry = "UPDATE {$_SESSION['DB_PREFIX']}siteconfig SET 
				...
				metamodifieduserid = " . getLoggedOnMemberID() . "";
...
<form id="contentForm" name="contentForm" method="post" class="entryform">
	...
	<textarea id="emailbody" name="emailbody" rows="15" cols="60" style="height:340px;width: 340px" class="tinyMCE"></textarea>
...
<script type="text/javascript">
	$(document).ready(function() {
			...
			$("#emailbody").val("<?php echo escape_notes($member['emailbody']); ?>");
